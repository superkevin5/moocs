...
(function() {
  ...
  function minifyTextarea() {
    try {
		// modified assett to pull out value from the appropriate edito
		//console.log('firstText: ' + byId('input').value);
		//console.log('secondText: ' + CKEDITOR.instances.editor1.getData());
		
      var options = getOptions(),
          lint = options.lint,
          //originalValue = byId('input').value,	
		  originalValue = CKEDITOR.instances.editor1.getData(),  
